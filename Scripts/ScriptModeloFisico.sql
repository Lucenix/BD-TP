...
CREATE TABLE IF NOT EXISTS `mydb`.`Relatorio` (
  ...
  `EstadoResolucao` TINYINT NOT NULL,
  `Descricao` VARCHAR(200) NOT NULL,
  `Gravidade` VARCHAR(1) NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`Funcionario_has_Percurso`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Funcionario_has_Percurso` (
  `Funcionario_idFuncionario` INT NOT NULL,
  `Percurso_idpercurso` INT NOT NULL,
  PRIMARY KEY (`Funcionario_idFuncionario`, `Percurso_idpercurso`),
  INDEX `fk_Funcionario_has_Percurso_Percurso1_idx` (`Percurso_idpercurso` ASC) VISIBLE,
  INDEX `fk_Funcionario_has_Percurso_Funcionario1_idx` (`Funcionario_idFuncionario` ASC) VISIBLE,
  CONSTRAINT `fk_Funcionario_has_Percurso_Funcionario1`
    FOREIGN KEY (`Funcionario_idFuncionario`)
    REFERENCES `mydb`.`Funcionario` (`idFuncionario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Funcionario_has_Percurso_Percurso1`
    FOREIGN KEY (`Percurso_idpercurso`)
    REFERENCES `mydb`.`Percurso` (`idpercurso`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
